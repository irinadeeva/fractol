...
t_fractol  *init_data(int type_fractal)
{
    ...
    data->max_iteration = 100; // Чем больше будет указанное число, тем точнее будет полученное изображение фрактала. И тем больше вычислительных задач ляжет на компьютер.
...
void    print_help()
{
    printf("A parameter is passed on the command line to define what type of fractal will be viewed.\n"
           "Please, choose one:\n"
